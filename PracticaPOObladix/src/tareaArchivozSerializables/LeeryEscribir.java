...
public class LeeryEscribir {
    ...
    public static void main(String[] args) {
        ...
        Estudiante p2=new Estudiante ("Vicente2","Luzuriaga2",22,"loja",new Materia
        (" Ingles ",2,"jhon",new Carrera("Contabilidad2",5,2)));
        Estudiante p3=new Estudiante (" pedro "," Robles ",23,"Pedrejal",new Materia
        (" fisica ",2,"jhon",new Carrera("Contabilidad3",5,2)));
           Estudiante p4=new Estudiante (" jose luis "," Cango ",24,"malacatos",new Materia
        ...
        (" quimica ",2,"jhon",new Carrera("Contabilidad3 ",5,2)));
                          Estudiante p11=new Estudiante (" Roberto "," Gonzalez ",19," santa cruz ",new Materia
...
//        System.out.println(Lista.size());
       objeto.escribirLista("C:\\Users\\USUARIO\\Desktop\\ejemplo.txt", Lista);
